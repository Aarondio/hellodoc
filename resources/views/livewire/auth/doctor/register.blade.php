            ...
            <form wire:submit.prevent="register">
                <div>
                    ...
                    <div class="mt-1 rounded-md shadow-sm">
                        <input wire:model.lazy="name" placeholder="E.g Muhammed Idris" id="name" type="text"
                            required autofocus
                ...
                <div class="mt-6">
                    ...
                    <div class="mt-1 rounded-md shadow-sm">
                        <input wire:model.lazy="email" placeholder="E.g muhammedidris@gmail.com" id="email"
                            type="email" required
                ...
                <div class="mt-6">
                    ...
                    <div class="mt-1 rounded-md shadow-sm">
                        <select wire:model.lazy="department_id"
                             required
                            class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:ring-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5 @error('department_id') border-red-300 text-red-900 placeholder-red-300 focus:border-red-300 focus:ring-red @enderror" >
