            ...
            <div class="w-11/12 lg:w-1/2   bg-white ring-1 ring-neutral-200 px-8 py-6 rounded-lg ">
                ...
                @if ($appointments->isEmpty())
                    <div class="flex flex-col items-center">
                        ...
                        <p class="text-slate-400">No pending appointment </p>
                    </div>
                @else
                    <div class="mb-3">
                        <h1 class="font-semibold text-slate-700">Pending Appointment</h1>
                    ...
                    @foreach ($appointments as $appointment)
                        <a href="{{ route('dad', $appointment->id) }}" wire:navigate>
                            <div class="ring-1 mt-2 rounded-lg ring-neutral-100 p-2 shadow-sm">
                                <div
                                    class=" flex justify-between bg-amber-100 rounded-md p-3">
                                    <div class="flex">
                                        <div
                                            class="   bg-amber-200  w-10 h-10 flex justify-center rounded-full">
                                    ...
                                    <a
                                        class=" text-gray-700 bg-amber-200 py-1 px-2 rounded-full text-sm self-center font-semibold">{{ $appointment->status }}</a>
                                </div>
